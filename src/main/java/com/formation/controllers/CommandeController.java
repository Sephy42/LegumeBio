...
public class CommandeController {
	...
	public Commande findOne (@PathVariable(name = "identifiant") Long id) {		
		Optional<Commande> opt = repo.findById(id);
		if (opt.isEmpty()) {
			throw new NotFoundException("La commande "+id+" n'a pas été trouvée");
		}
		return opt.get();
	}
	...
	public Commande save(@RequestBody Commande cl) {
		return repo.save(cl);
