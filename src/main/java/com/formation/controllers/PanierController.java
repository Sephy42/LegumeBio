...
import com.formation.persistence.repositories.IPanierRepository;
...
public class PanierController {
	...
	public Panier findOne (@PathVariable(name = "identifiant") Long id) {		
		Optional<Panier> opt = repo.findById(id);
		if (opt.isEmpty()) {
			throw new NotFoundException("Le panier "+id+" n'a pas été trouvé");
		}
		return opt.get();
	}
	...
	public Panier save(@RequestBody Panier cl) {
		return repo.save(cl);
